              ...
              <div>
                ...
                <div className="pl-3 space-y-2 text-zinc-400 text-xs font-bold leading-relaxed">
                  ...
                  <ul className="list-disc list-inside text-[#fe9a00] ml-2 space-y-1">
                    ...
                    <li><span className="text-zinc-300">Checking the <strong className="text-white">AM News</strong> section daily earns you a steady stream of bonus points.</span></li>
